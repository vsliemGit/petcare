            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class=" form">
                            <form class="cmxform form-horizontal " id="commentForm" action="{{Route('service.store')}}" method="post" enctype="multipart/form-data" novalidate="novalidate">
                                @csrf
                                <div class="form-group ">
                                    <label for="service_name" class="control-label col-lg-3">Name services <span class="required" style="color:red">*</span></label>
                                    <div class="col-lg-6">
                                        <input class=" form-control" id="service_name" name="service_name" minlength="2" type="text" required="">
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="service_slug" class="control-label col-lg-3">Slug <span class="required" style="color:red">*</span></label>
                                    <div class="col-lg-6">
                                        <input class=" form-control" id="service_slug" name="service_slug" minlength="2" type="text" required="">
                                    </div>
                                </div>
                                <div class="form-group ">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control" style="resize: none" rows="8" id="service_desc" name="service_desc" required=""></textarea>
                                    </div>
                                </div>
                                <div class="form-group ">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-3 col-lg-6">
                                        <button class="btn btn-primary" name="add_service" type="submit">Thêm</button>
