            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        Add Detail Product {{$product->product_name}}
                    </header>
                    <div class="panel-body">
                        <div class=" form">
                            <form class="cmxform form-horizontal " id="commentForm" action="{{route('product.detail.add', ['id' => $product->product_id])}}" method="post" enctype="multipart/form-data" novalidate="novalidate">
                                @csrf
                                <div class="form-group">
                                    <label for="product_name" class=" col-lg-3">Name product <span class="required" style="color:red">*</span></label>
                                    <div class="col-lg-12">
                                        <input class="form-control" minlength="2"  value="{{ old('product_name', $product->product_name) }}" type="text"  readonly>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="product_content" class="col-lg-3">Content</label>
                                    <div class="col-lg-12">
                                        <textarea class="form-control" style="resize: none" rows="8" id="product_content" name="product_content" required=""></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
